...
void test3(){
    ...
    int* ptr = arr1.data(); // The data method returns the raw pointer that points to the raw array.
...
void test6(){
    ...
    //It searches through a container and retirns the first
    //occurence of 2 adjacent values.
